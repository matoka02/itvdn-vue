<template>
  <div class="pagination">
    ...
    <button v-for="pageNumber in visiblePageNumbers" :key="pageNumber" @click="handleChangePage(pageNumber)"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { visiblePageNumbers, showFirstEllipsis, showLastEllipsis, handleChangePage, };
  },
});
</script>
